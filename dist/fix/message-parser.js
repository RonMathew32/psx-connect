...
class FixMessageParser {
     ...
     */
    static isMessageType(message, type) {
        return message[constants_1.FieldTag.MSG_TYPE.toString()] === type;
    }
    /**
     * Check if a message is a logon message
     */
    static isLogon(message) {
        return this.isMessageType(message, constants_1.MessageType.LOGON);
    }
    /**
     * Check if a message is a logout message
     */
    static isLogout(message) {
        return this.isMessageType(message, constants_1.MessageType.LOGOUT);
    }
    /**
     * Check if a message is a heartbeat message
     */
    static isHeartbeat(message) {
        return this.isMessageType(message, constants_1.MessageType.HEARTBEAT);
    }
    /**
     * Check if a message is a test request message
     */
    static isTestRequest(message) {
        return this.isMessageType(message, constants_1.MessageType.TEST_REQUEST);
    }
    /**
     * Check if a message is a market data snapshot message
     */
    static isMarketDataSnapshot(message) {
        return this.isMessageType(message, constants_1.MessageType.MARKET_DATA_SNAPSHOT_FULL_REFRESH);
    }
    /**
     * Check if a message is a market data incremental refresh message
     */
    static isMarketDataIncremental(message) {
        return this.isMessageType(message, constants_1.MessageType.MARKET_DATA_INCREMENTAL_REFRESH);
    }
    /**
     * Check if a message is a security list message
     */
    static isSecurityList(message) {
        return this.isMessageType(message, constants_1.MessageType.SECURITY_LIST);
    }
    /**
     * Check if a message is a trading session status message
     */
    static isTradingSessionStatus(message) {
        return this.isMessageType(message, constants_1.MessageType.TRADING_SESSION_STATUS);
    }
    /**
     * Check if a message is a reject message
     */
    static isReject(message) {
        return this.isMessageType(message, constants_1.MessageType.REJECT);
    }
    /**
     * Get the SenderCompID from a message
     */
    static getSenderCompID(message) {
        return message[constants_1.FieldTag.SENDER_COMP_ID.toString()] || '';
    }
    /**
     * Get the TargetCompID from a message
     */
    static getTargetCompID(message) {
        return message[constants_1.FieldTag.TARGET_COMP_ID.toString()] || '';
    }
    /**
     * Get the MsgSeqNum from a message
     */
    static getMsgSeqNum(message) {
        return parseInt(message[constants_1.FieldTag.MSG_SEQ_NUM.toString()] || '0', 10);
    }
    /**
     * Get the TestReqID from a message
     */
    static getTestReqID(message) {
        return message[constants_1.FieldTag.TEST_REQ_ID.toString()] || '';
    }
    /**
     * Get the MDReqID from a message
     */
    static getMDReqID(message) {
        return message[constants_1.FieldTag.MD_REQ_ID.toString()] || '';
    }
    /**
     * Get error text from a reject message
     */
    static getRejectText(message) {
        return message['58'] || ''; // Text is tag 58
    }
    /**
     * Verify the message checksum
     */
    static verifyChecksum(message) {
