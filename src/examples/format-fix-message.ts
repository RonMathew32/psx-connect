...
import { FixMessageParser } from '../fix/message-parser';
import { SOH } from '../fix/constants';
...
const parsedMessage = FixMessageParser.parse(logonMessage);
...
Object.entries(parsedMessage).forEach(([tag, value]) => {
  ...
  switch (tag) {
    case '8': fieldName = 'BeginString'; break;
    case '9': fieldName = 'BodyLength'; break;
    case '35': fieldName = 'MsgType'; break;
    case '49': fieldName = 'SenderCompID'; break;
    case '56': fieldName = 'TargetCompID'; break;
    case '34': fieldName = 'MsgSeqNum'; break;
    case '52': fieldName = 'SendingTime'; break;
    case '98': fieldName = 'EncryptMethod'; break;
    case '108': fieldName = 'HeartBtInt'; break;
    case '141': fieldName = 'ResetSeqNumFlag'; break;
    case '553': fieldName = 'Username'; break;
    case '554': fieldName = 'Password'; break;
    case '1137': fieldName = 'DefaultApplVerID'; break;
    case '1129': fieldName = 'DefaultCstmApplVerID'; break;
    case '115': fieldName = 'OnBehalfOfCompID'; break;
    case '96': fieldName = 'RawData'; break;
    case '95': fieldName = 'RawDataLength'; break;
    case '10': fieldName = 'CheckSum'; break;
    default: fieldName = 'Unknown'; break;
  }
...
// Verify the checksum
const isValid = FixMessageParser.verifyChecksum(logonMessage);
console.log('');
